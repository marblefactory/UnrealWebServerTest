...
#include "Private/HttpStatusCode.h"  // https://answers.unrealengine.com/questions/427309/ustruct-type-must-be-a-uclass-ustruct-or-uenum.html
#include "Response.h"
...
public:
	...
	* @param responseData The string containing the response : it must include headers, such as response code and so on...
	*/
